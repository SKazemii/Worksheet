...
class MRMR:
    ...
    def fit(self):
        ...
        print(  "Die Feature Menge:" )
        print(self.SetX)
        print(  "Die klassifizierende Menge:" )
        print(self.SetY)
...
def main():
    ...
    print("[INFO] feature shape: ", pfeatures.shape)
    columnsName = ["feature_" + str(i) for i in range(pfeatures.shape[1]-2)] + [ "subject ID", "left(0)/right(1)"]
    ...
    a = MRMR(DF_features.iloc[:,0:5],DF_features.iloc[:,-1])
    b = a.fit()
    print(b[0])
    # relevent_features = Max_relevence(features,labels, n=10)
    # print(relevent_features)
    # print(relevent_features.shape)
    # print(F)
    # SetX = [[1,2,4,5,6], [62,2,23,6,9], [2,3,5,6,7], [4,1,4,9,34],
    #             [23,2,54,5,7]]
    # SetX = [[1,62,2,4,23], [2,2,3,1,2], [4,23,5,4,54], [5,6,6,9,5],
    #             [6,9,7,34,7]]
    ...
    # Datenbeispiel = MRMR(DF_features, SetY, "pearson")
    # Resultat = Datenbeispiel.fit()
    # print(Resultat[0])
    print("[INFO] Done!!!")
