...
\section{the best and worst top models}
    \begin{frame}
    \frametitle{The best top models on left foot}
    \tiny
    \begin{table}
    \centering
    \captionsetup{labelformat=empty}
    ...
    \end{frame}
    \begin{frame}
    \frametitle{The best top models on right foot}
    \tiny
    \begin{table}
    \centering
    \captionsetup{labelformat=empty}
    ...
    \begin{frame}
    \frametitle{The worst top models on left foot}
    \tiny
    \begin{table}
    \centering
    \captionsetup{labelformat=empty}
    ...
    \end{frame}
    \begin{frame}
    \frametitle{The worst top models on right foot}
    \tiny
    \begin{table}
    \centering
    \captionsetup{labelformat=empty}
